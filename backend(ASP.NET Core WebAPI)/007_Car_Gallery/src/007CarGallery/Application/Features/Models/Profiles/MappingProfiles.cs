...
using Application.Features.Models.Queries.GetModelByBrand;
...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<Model, GetListGetModelByBrandListItemDto>().ReverseMap();
        CreateMap<IPaginate<Model>, GetListResponse<GetListGetModelByBrandListItemDto>>().ReverseMap();
