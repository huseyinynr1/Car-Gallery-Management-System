import React from "react"; // React kütüphanesini içe aktarıyoruz, bu sayede JSX ve React bileşenlerini kullanabiliriz.
...
export default Gauge; // Bu bileşeni diğer dosyalarda kullanmak için dışa aktarıyoruz.
